...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.dispatchToMaster = exports.sendToMaster = exports.listenToMaster = undefined;
	
	var _moves = __webpack_require__(283);
	
	var listenToMaster = exports.listenToMaster = function listenToMaster(action) {
		return function (dispatch, getState) {
			var onMasterMessage = function onMasterMessage(event) {
				var data = JSON.parse(event.data);
				if (data.function === 'dispatch') {
					dispatch(data.action);
				} else if (data.function === 'setMovesTimeouts') {
					dispatch((0, _moves.setMovesTimeouts)(data.forward));
				} else if (data.function === 'stopMoves') {
					dispatch((0, _moves.stopMoves)());
				}
			};
	...
	var sendToMaster = exports.sendToMaster = function sendToMaster(message) {
		self.postMessage(JSON.stringify(message));
	};
	
	var dispatchToMaster = exports.dispatchToMaster = function dispatchToMaster(action) {
		var message = { function: 'dispatch', action: action };
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.stopMoves = exports.setMovesTimeouts = undefined;
	
	var _constants = __webpack_require__(6);
	
	var _constants2 = _interopRequireDefault(_constants);
	
	var _slave = __webpack_require__(136);
	...
	var setMovesTimeouts = exports.setMovesTimeouts = function setMovesTimeouts() {
		...
		return function (dispatch, getState) {
			var moves = getState().dance.get('moves').toArray();
			var movesTimeouts = moves.map(function (move, index) {
				var timeoutShow = setTimeout(function () {
					(0, _slave.dispatchToMaster)({
						type: _constants2.default.MOVE_SHOW,
						index: index
					});
				}, move.showTime - forward);
				var timeoutCommentable = setTimeout(function () {
					(0, _slave.dispatchToMaster)({
						type: _constants2.default.MOVE_COMMENTABLE,
						index: index
					});
				}, move.time - _constants2.default.MOVE_TOLERANCE_OK - forward);
				var timeoutHide = setTimeout(function () {
					(0, _slave.dispatchToMaster)({
						type: _constants2.default.MOVE_HIDE,
						index: index
					});
				}, move.time - forward);
				var timeoutUncommentable = setTimeout(function () {
					(0, _slave.dispatchToMaster)({
						type: _constants2.default.MOVE_UNCOMMENTABLE,
						index: index
					});
				}, move.time + _constants2.default.MOVE_TOLERANCE_OK - forward);
				return {
					timeoutShow: timeoutShow,
					timeoutCommentable: timeoutCommentable,
					timeoutHide: timeoutHide,
					timeoutUncommentable: timeoutUncommentable
				};
			});
			(0, _slave.dispatchToMaster)({
				type: _constants2.default.MOVES_TIMEOUTS,
				timeouts: movesTimeouts
			});
		};
	};
	
	var movesTimeouts = ['timeoutShow', 'timeoutCommentable', 'timeoutHide', 'timeoutUncommentable'];
	
	var stopMoves = exports.stopMoves = function stopMoves() {
		return function (dispatch, getState) {
			var moves = getState().dance.get('moves').toArray();
			moves.forEach(function (move) {
				movesTimeouts.forEach(function (timeout) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _slave = __webpack_require__(310);
	
	var _slave2 = __webpack_require__(136);
	
	var store = (0, _slave.configureStore)();
	store.dispatch((0, _slave2.listenToMaster)());
...
/***/ function(module, exports, __webpack_require__) {
	...
	var configureStore = exports.configureStore = function configureStore(thread) {
